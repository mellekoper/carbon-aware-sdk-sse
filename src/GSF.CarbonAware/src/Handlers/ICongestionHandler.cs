...
{
    public interface ICongestionHandler
    {
        /// <summary>
        ...
        /// <returns>Array of <see cref="CongestionData"/> objects that contains the location, time and the rating in g/kWh</returns>
        Task<IEnumerable<CongestionData>> GetCongestionDataAsync(string location, DateTimeOffset? start = null, DateTimeOffset? end = null);
        ...
        /// <param name="end">[Optional] End time for the data query. (ex: 2022-03-01T18:30:00Z)</param>
        /// <returns>Array of <see cref="CongestionData"/> objects that contains the location, time and the rating in g/kWh</returns>
        Task<IEnumerable<CongestionData>> GetCongestionDataAsync(string[] locations, DateTimeOffset? start = null, DateTimeOffset? end = null);
        ...
        /// <param name="start">[Optional] Start time for the data query. (ex: 2022-03-01T15:30:00Z)</param>
        /// <param name="end">[Optional] End time for the data query. (ex: 2022-03-01T18:30:00Z)</param>
        /// <returns>An array of <see cref="CongestionData"/> objects that contains the location, and the best time and rating in g/kWh</returns>
        Task<IEnumerable<CongestionData>> GetBestCongestionDataAsync(string location, DateTimeOffset? start = null, DateTimeOffset? end = null);
        ...
        /// <param name="start">[Optional] Start time for the data query. (ex: 2022-03-01T15:30:00Z)</param>
        /// <param name="end">[Optional] End time for the data query. (ex: 2022-03-01T18:30:00Z)</param>
        /// <returns>An array of <see cref="CongestionData"/> objects that contains the location, time and the rating in g/kWh</returns>
        Task<IEnumerable<CongestionData>> GetBestCongestionDataAsync(string[] locations, DateTimeOffset? start = null, DateTimeOffset? end = null);
        ...
        Task<(double, double, double)> GetAverageCongestionAsync(string location, DateTimeOffset? start, DateTimeOffset? end);
    }
}
